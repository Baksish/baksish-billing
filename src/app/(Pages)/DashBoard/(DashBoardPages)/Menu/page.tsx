...
const MenuPage = () => {
  ...
  useEffect(() => {
    if (menu) {
      const groupedItems = menu.reduce((acc: Record<string, MenuItem[]>, item: MenuItem) => {
        ...
        {!isLoading && (
          <div className="mt-10 mx-10">
            <div className="flex justify-center align-center">
              <div className="px-16 py-6 w-fit shadow-xl bg-slate-800 p-4 text-white rounded-md flex space-x-4 justify-center items-center">
                <p className="text-lg">
